  ...
  if (!window.dict) {
    window.dict = {
      es: {
        ...
        "about.body": "Soy <strong>Ana Ordóñez Gragera</strong>, tengo <strong>23 años</strong> y he completado la carrera de <strong>Diseño y Desarrollo de Videojuegos</strong> en la Universidad Rey Juan Carlos. Mi pasión por los videojuegos y la animación 3D me ha llevado a desarrollar proyectos que abarcan desde un <em>Arkanoid</em> en ensamblador hasta un multijugador online de carreras, pasando por animaciones, simulaciones físicas y concept art.",
      ...
      en: {
        ...
        "about.body": "I'm <strong>Ana Ordóñez Gragera</strong>, <strong>23 years old</strong>, and I’ve completed a degree in <strong>Game Design and Development</strong> at Universidad Rey Juan Carlos. My passion for video games and 3D animation has led me to develop projects ranging from an <em>Arkanoid</em> in assembly language to an online multiplayer racing game, including animations, physics simulations, and concept art.",
